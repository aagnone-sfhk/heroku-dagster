...
web: DAGSTER_DATABASE_URL="${DATABASE_URL//postgres:\/\//postgresql:\/\/}" dagster-webserver -h 0.0.0.0 -p $PORT
...
# Convert postgres:// to postgresql:// for SQLAlchemy 2.0 compatibility
worker: DAGSTER_DATABASE_URL="${DATABASE_URL//postgres:\/\//postgresql:\/\/}" dagster-daemon run
